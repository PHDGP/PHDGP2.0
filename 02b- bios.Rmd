...
knitr::include_graphics("images/biophotos/nk.jpg")
```
...
```{r, echo=FALSE, message=FALSE, out.width="300px"}
knitr::include_graphics("images/biophotos/jc.jpg")
```
...
```{r, echo=FALSE, message=FALSE, out.width="300px"}
knitr::include_graphics("images/biophotos/eh.jpg")
```
...
```{r, echo=FALSE, message=FALSE, out.width="300px"}
knitr::include_graphics("images/biophotos/dj.jpg")
```
...
```{r, echo=FALSE, message=FALSE, out.width="300px"}
knitr::include_graphics("images/biophotos/jm.jpg")
```
...
```{r, echo=FALSE, message=FALSE, out.width="300px"}
knitr::include_graphics("images/biophotos/tr.jpg")
```
...
```{r, echo=FALSE, message=FALSE, out.width="300px"}
knitr::include_graphics("images/biophotos/ss.jpg")
```
...
```{r, echo=FALSE, message=FALSE, out.width="300px"}
knitr::include_graphics("images/biophotos/ct.jpg")
```
