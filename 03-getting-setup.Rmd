...
:::: {.infobox .info}
We want to emphasize that these materials have been designed to facilitate
learning either by following along with the code (to learn the hands-on skills of
programming with georeferenced data in R) and/or skipping reading/running the
code and reading the accompanying exposition and text and figures so as to learn
the principles behind the methodologies shown. The code included in this work is
meant to help facilitate learning about how to work with georeferenced data, but
readers more interested in learning the principles of working with georeferenced
data who either aren't ready or aren't interested in tackling the project of
running the code given should feel free to learn from these materials in the way
