...
#| include = TRUE,
#| fig.align = 'center',
#| fig.cap = paste0("The composite parts of georeferenced data for mapping area rates ",
#|   "(numerators, denominators, and geography shapefiles) are linked together by area identifiers.")
knitr::include_graphics("images/04-getting-your-data/geodata_diagram.png")
```
...
If you are studying area level health outcome rates, you may find that you 
must source these different necessary pieces from different places such as 
population estimates from the Census or its products, health 
outcomes from healthcare providers, electronic health records (EHR), 
