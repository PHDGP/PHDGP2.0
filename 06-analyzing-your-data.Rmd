...
knitr::include_graphics("absm_age_plot.png")
```

```{r, echo=FALSE, warning=FALSE, message=FALSE, eval=FALSE}
table_direct_age_std <- read_csv("direct_age_standardization_example.csv")
...
```{r, echo=FALSE, warning=FALSE, message=FALSE, eval=FALSE}
table_direct_std_rates <- read_csv("age_standardization_example_summed.csv")
...
- Analyses by racialized group and ABSM
- Reporting on interaction
...
```{r, echo=FALSE, out.width="100%", fig.cap="Comparison of estimates of social inequities by ABSM from the aggregated method and from non-spatial regression models", eval=FALSE}

knitr::include_graphics("non_spatial_coefficient_plot.png")
...
```{r, echo=FALSE, fig.cap="Caterpillar plots of raw SMRs with 95% CIs and smoothed SMRs from a Poisson gamma model with 95% credible intervals", eval=FALSE}
knitr::include_graphics("rawVsEB_SMR_caterpillar.png")
```
...
```{r, echo=FALSE, fig.cap="Maps of raw SMRs (left) and smoothed SMRs from a Poisson gamma model", eval=FALSE}
knitr::include_graphics("premature_raw_SMR_v_empbayes.png")
```
...
```{r, echo=FALSE, fig.cap="Caterpillar plots of raw SMRs with 95% CIs and smoothed SMRs from a Poisson lognormal model with 95% credible intervals", eval=FALSE}
knitr::include_graphics("raw_vs_poissoniid.png")
```

```{r, echo=FALSE, fig.cap="Maps of raw SMRs (left) and smoothed SMRs from a Poisson lognormal model", eval=FALSE}
knitr::include_graphics("premature_boston_raw_poissonmod0.png")
```
...
```{r, echo=FALSE, fig.cap="Maps of CT raw SMRs (left) and smoothed SMRs from a Poisson multilevel model", eval=FALSE}
knitr::include_graphics("premature_raw_SMR_v_multimod.png")
```

```{r, echo=FALSE, fig.cap="Map of the neighborhood level variation in relative risk (Level 2 of the Poisson multilevel model)", eval=FALSE}
knitr::include_graphics("premature_boston_neigh_rr.png")
```
...
```{r caridea, echo=FALSE, out.width="60%", fig.cap="Illustration of the CAR idea", eval=FALSE}
knitr::include_graphics("CARillustration.png")
```
...
```{r qr90idea, echo=FALSE, out.width="60%", fig.cap="Depiction of QR90: the contrast between the 95th and 5th quantiles of the random effects distribution", eval=FALSE}
knitr::include_graphics("qr90_idea.png")
```
\includegraphics[width=3.5in]{../qr90_idea.pdf}



```{r, echo=FALSE, fig.cap="Caterpillar plots of raw SMRs with 95% CIs and smoothed SMRs from a Poisson BYM model with 95% credible intervals", eval=FALSE}
knitr::include_graphics("raw_vs_bymmod0.png")
```



```{r, echo=FALSE, fig.cap="Comparison of premature mortality raw SMRs and smoothed (BYM) SMRs", eval=FALSE}
knitr::include_graphics("premature_boston_raw_smooth.png")
```
...
```{r, echo=FALSE, fig.cap="ABSMs vs. smoothed SMRs (BYM)", eval=FALSE}
knitr::include_graphics("premature_smoothSMR_vs_absms.png")
```

```{r, echo=FALSE, fig.cap="Comparison of premature mortality inequities by ABSM categories across all analytic methods and models", eval=FALSE}
knitr::include_graphics("premature_all_coefficients_plot.png")
```

```{r, echo=FALSE, message=FALSE, eval=FALSE}
table_absm_inla <- read_csv("coefficient_tab_inla.csv") %>%
...
```{r, echo=FALSE, fig.cap="Premature mortality: comparison of smoothed SMRs (BYM) before and after adjustment for CT % below poverty", eval=FALSE}
knitr::include_graphics("premature_boston_apINDPOV_before_after.png")
```

```{r, echo=FALSE, fig.cap="Premature mortality: comparison of smoothed SMRs (BYM) before and after adjustment for CT Index of Concentration at the Extremes (racialized economic segregation)", eval=FALSE}
knitr::include_graphics("premature_boston_qICEwnhinc_before_after.png")
```

```{r, echo=FALSE, fig.cap="Premature mortality: comparison of smoothed SMRs (BYM) before and after adjustment for CT Social Vulnerability Index", eval=FALSE}
knitr::include_graphics("premature_boston_qsvi_before_after.png")
```


### Lung cancer mortality

```{r, echo=FALSE, fig.cap="Lung cancer mortality: CT ABSMs vs. smoothed SMRs (BYM)", eval=FALSE}
knitr::include_graphics("lung_smoothSMR_vs_absms.png")
```

```{r, echo=FALSE, fig.cap="Comparison of lung cancer mortality inequities by CT ABSM categories across all analytic methods and models", eval=FALSE}
knitr::include_graphics("lung_all_coefficients_plot.png")
```


```{r, echo=FALSE, message=FALSE, eval=FALSE}
lung_table_absm_inla <- read_csv("lung_coefficient_tab_inla.csv") %>%
  dplyr::select(term, qval, estimate, conf.low, conf.high, method) %>%
  filter(method %in% c("Aggregated", "Quasipoisson", "Negative binomial", "BYM")) %>%
  pivot_wider(id_cols = c(term, qval),
              names_from=method,
...
```{r, echo=FALSE, fig.cap="Lung cancer: comparison of smoothed SMRs (BYM) before and after adjustment for CT % below poverty", eval=FALSE}
knitr::include_graphics("lung_boston_apINDPOV_before_after.png")
```

```{r, echo=FALSE, fig.cap="Lung cancer: comparison of smoothed SMRs (BYM) before and after adjustment for CT Index of Concentration at the Extremes (racialized economic segregation)", eval=FALSE}
knitr::include_graphics("lung_boston_qICEwnhinc_before_after.png")
```

```{r, echo=FALSE, fig.cap="Lung cancer: comparison of smoothed SMRs (BYM) before and after adjustment for CT Social Vulnerability Index", eval=FALSE}
knitr::include_graphics("lung_boston_qsvi_before_after.png")
```
...
Wakefield, J.C., Best, N.G. and Waller, L. Bayesian approaches to diseasemapping,  In:  Elliott,  P.,  Wakefield,  J.C.,  Best,  N.G.  and  Briggs,  D.J. SpatialEpidemiology: Methods and Applications, Oxford University Press, London, UK.pp 104–127, 2000.
