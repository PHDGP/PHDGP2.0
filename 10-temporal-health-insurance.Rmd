...
ggsave("images/10-temporal-health-insurance/california.png", width = 8, height = 4)
map_health_insurance_over_time('Florida', estimate_zero_to_64_insurance_prop)
ggsave("images/10-temporal-health-insurance/florida.png", width = 8, height = 4)
map_health_insurance_over_time('Massachusetts', estimate_zero_to_64_insurance_prop)
ggsave("images/10-temporal-health-insurance/massachusetts.png", width = 8, height = 4)
map_health_insurance_over_time('Texas', estimate_zero_to_64_insurance_prop)
ggsave("images/10-temporal-health-insurance/texas.png", width = 8, height = 4)
```
...
ggsave("images/10-temporal-health-insurance/texasmoe.png", width = 8, height = 4)
...
ggsave("images/10-temporal-health-insurance/massmoe.png", width = 8, height = 4)
...
ggsave("images/10-temporal-health-insurance/floridamoe.png", width = 8, height = 4)
```
...
#| include = FALSE,
#| eval = FALSE
ggsave("images/10-temporal-health-insurance/povertycomparison.png", width = 8, height = 4)
```
...
health_insurance %>% 
  ...
  ggtitle("Relationship Between Percent with Health Insurance by ICE for Racialized \nEconomic Segregation over Time",
          "County Observations, Texas -- Weighted by Inverse Margin of Error") 
ggsave("images/10-temporal-health-insurance/healthinsurance_ICE_time.png", width = 8, height = 4)
...
health_insurance %>% 
  ...
  ggtitle("Relationship Between Percent with Health Insurance by Percent in Poverty \nover Time",
          "County Observations, Texas -- Weighted by Inverse Margin of Error")
ggsave("images/10-temporal-health-insurance/healthinsurance_poverty_time.png", width = 8, height = 4)
