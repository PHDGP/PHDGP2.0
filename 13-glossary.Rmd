...
**index of concentration at the extremes (ICE)** a measure of spatial social polarization quantifying extremes of deprived and privileged social groups using a single metric while jointly measuring economic and racial/ethnic segregation.
...
**person-tim** The sum of the time at risk for all persons in a population.
